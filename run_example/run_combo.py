...
def get_args():
    ...
    parser.add_argument("--cql-weight", type=float, default=0.5)  # beta in CQL and COMBO
...
def train(args=get_args()):
    ...
    if args.task.split('-')[0] == "halfcheetah-jump":
    ...
    # log
    log_dirs = make_log_dirs(args.task, args.algo_name, args.seed, vars(args), record_params=["rho_s"])

...
if __name__ == "__main__":
    ...
    parser.add_argument("--algos", type=str, nargs='*', default=["mopo&penalty_coef=10.0&rollout_length=5"])
    ...
    parser.add_argument("--xlabel", default="Gradient Steps")
    parser.add_argument("--ylabel", default=None)
    parser.add_argument("--smooth", type=int, default=10)
    parser.add_argument("--colors", type=str, nargs='*', default=None)
    parser.add_argument("--show", action='store_true')
    parser.add_argument("--output-path", default=False)
    parser.add_argument("--figsize", type=float, nargs=2, default=(22, 6))
